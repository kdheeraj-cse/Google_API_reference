...
<title>Google Api Reference</title>
...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">Google API's</a>
			</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">List of API's projects</h1>
			</div>
		</div>
		<!-- /.row -->
		...
		<div class="row">
			<div class="col-md-7">
					<img class="img-responsive apibanner" src="image/Geocoding.jpg"
						alt="geocoding">
			</div>
			<div class="col-md-5">
				<h4>Geocoding API</h4>
				<p>Geocoding is the process of converting addresses (like "1600
					Amphitheatre Parkway, Mountain View, CA") into geographic
					coordinates (like latitude 37.423021 and longitude -122.083739),
					which you can use to place markers on a map, or position the map.</p>
				<a class="btn btn-primary" href="geocoding/geocoding.jsp">View Project <span
		...
		<div class="row">
			<div class="col-md-7">
				<img class="img-responsive apibanner"
					src="image/google-places.png" alt="google places">
			</div>
			<div class="col-md-5">
				<h4>Google places API</h4>
				<p>Make your app stand out with detailed information about 100 million places across a wide range of categories, from the same database as Google Maps and Google+</p>
				<a class="btn btn-primary" href="google_places/googleplaces.jsp">View Project <span
					class="glyphicon glyphicon-chevron-right"></span></a>
			</div>
		</div>
		<!-- /.row -->
		...
		<footer>
			<div class="row">
				...
				<div class="col-md-6"></div>
					<p><a href="https://github.com/kdheeraj-cse/Google_API_reference"></a>Github source <span class="icon-large icon-github"></span></p>
			</div>
			<!-- /.row -->
		</footer>
