...
<head>
    ...
    <!-- Custom CSS -->
    <link href="xlib/bootstrap-3.3.5/css/1-col-portfolio.css" rel="stylesheet">
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">List of API's projects
                </h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <a class="btn btn-primary" href="geocoding.jsp">View Project <span class="glyphicon glyphicon-chevron-right"></span></a>
            </div>
        </div>
        <!-- /.row -->
	...
	<script type="text/javascript" src="xlib/bootstrap-3.3.5/js/bootstrap.min.js"></script>
