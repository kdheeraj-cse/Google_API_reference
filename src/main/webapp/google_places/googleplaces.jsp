...
<body onload="getNearPlaces()">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Google Places</h1>
			</div>
		</div>
		<!-- /.row -->
		...
		<div class="row">
			...
			<div class="col-md-5">
				...
				<tr><td>Address (Optional)&nbsp</td><td><input type="text" id="queryAddress"></td></tr>
				<tr><td>Type&nbsp</td><td><input type="text" id="queryType"></td></tr>
				<tr><td>Name&nbsp</td><td><input type="text" id="queryName"></td></tr>
				<tr><td>Radius&nbsp</td><td><input type="text" id="queryRadius"></td></tr>
				</table>
				<br>
	...
	<script type="text/javascript" src="placesScript.js"></script>
